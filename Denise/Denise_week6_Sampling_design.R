...
# Random sampling 
sp1 <- spsample(x = mydata, n = 10, type = 'random')
points(sp1, pch=16, col = 'black')

# Systematic sampling 
sp2 <- spsample(x = mydata, n = 10, type = 'regular') # distance between points is even
points(sp2, pch=15, col = 'blue')

# Stratified random sampling?
sp3 <- spsample(x = mydata, n = 10, type = 'stratified') 
points(sp3, pch=15, col = 'blue')
